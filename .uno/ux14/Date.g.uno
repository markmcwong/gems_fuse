...
public partial class Date: Fuse.Controls.DockPanel
{
    string _field_Text;
    ...
    {
        [Uno.WeakReference] internal readonly Date __parent;
        [Uno.WeakReference] internal readonly Date __parentInstance;
        public Template(Date parent, Date parentInstance): base(null, false)
        {
            __parent = parent;
        ...
        public override object New()
        {
            ...
            var temp1 = new global::Fuse.Reactive.Property(temp, Gems_accessor_Date_Text.Singleton);
    ...
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly Date __parent;
        [Uno.WeakReference] internal readonly Date __parentInstance;
        public Template1(Date parent, Date parentInstance): base(null, false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
    ...
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly Date __parent;
        [Uno.WeakReference] internal readonly Date __parentInstance;
        public Template2(Date parent, Date parentInstance): base(null, false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
    ...
    void InitializeUX()
    {
        ...
        var temp2 = new global::Fuse.Reactive.Property(temp1, Gems_accessor_Date_Text.Singleton);
